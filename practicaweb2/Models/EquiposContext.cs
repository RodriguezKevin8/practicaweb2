...
public partial class EquiposContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CarreraId).HasName("PK__carreras__1F1EC7007A96C4C8");
        ...
        {
            entity.HasKey(e => e.IdEstadosEquipo).HasName("PK__estados___BE0FBCF9DD2F57ED");
        ...
        {
            entity.HasKey(e => e.EstadoResId).HasName("PK__estados___5E7C248C3A2DDE7A");
        ...
        {
            entity.HasKey(e => e.FacultadId).HasName("PK__facultad__6407F1AEFDC548C0");
        ...
        {
            entity.HasKey(e => e.IdMarcas).HasName("PK__marcas__7918CF24136BBEFF");
        ...
        {
            entity.HasKey(e => e.ReservaId).HasName("PK__reservas__F1437E48DFB021E2");
        ...
        {
            entity.HasKey(e => e.IdTipoEquipo).HasName("PK__tipo_equ__82617B3256628ABD");
        ...
        {
            entity.HasKey(e => e.UsuarioId).HasName("PK__usuarios__2ED7D2AFE716924B");
